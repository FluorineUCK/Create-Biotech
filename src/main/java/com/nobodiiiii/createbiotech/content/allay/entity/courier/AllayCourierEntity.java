package com.nobodiiiii.createbiotech.content.allay.entity.courier;
...
import com.nobodiiiii.createbiotech.content.allay.logistics.courier.AllayCourierTask;
...
public class AllayCourierEntity extends Allay implements Container {
	...
	public static AllayCourierEntity createWaiting(Level level, ItemStack box, Vec3 launchDirection) {
		AllayCourierEntity courier = new AllayCourierEntity(CBEntityTypes.ALLAY_COURIER.get(), level);
