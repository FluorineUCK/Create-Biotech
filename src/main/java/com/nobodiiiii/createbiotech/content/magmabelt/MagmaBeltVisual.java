...
public class MagmaBeltVisual extends KineticBlockEntityVisual<MagmaBeltBlockEntity> {
	...
	public static final float SCROLL_FACTOR_OTHERWISE = .5f;
	public static final float SCROLL_OFFSET_BOTTOM = .5f;
	...
	private Direction getOrientation() {
		Direction direction = blockState.getValue(MagmaBeltBlock.HORIZONTAL_FACING)
			.getClockWise();
		if (blockState.getValue(MagmaBeltBlock.SLOPE) == BeltSlope.SIDEWAYS)
